...
<html lang="">
	...
	<body>
		<ul class="pager">
			...
			<li><a href="?controller=c_rental&action=list_rental_records">List Rental records</a></li>
		</ul>

		<div class="container">
			<h1 class="text-center">Details of the Cars</h1>
			<div class="table-responsive">
				<table class="table table-condensed btn-success">
					...
					<tbody>
					<?php foreach ($list_rentals as $key => $value):?>
						<tr>
